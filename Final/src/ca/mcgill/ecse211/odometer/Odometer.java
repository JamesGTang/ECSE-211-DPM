...
public class Odometer extends OdometerData implements Runnable {
  ...
  public void run() {
    ...
    while (true) {
      ...
      leftMotorDistance = Math.PI*WHEEL_RAD*(leftMotorTachoCount - leftMotorLastTachoCount)/180;
      rightMotorDistance = Math.PI*WHEEL_RAD*(rightMotorTachoCount - rightMotorLastTachoCount)/180;
      
      deltaD = 0.5*(leftMotorDistance + rightMotorDistance);
      deltaT = ((leftMotorDistance - rightMotorDistance)/TRACK)*180/Math.PI;
      dTheta =odo.getTheta();
